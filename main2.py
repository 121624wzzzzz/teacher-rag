...
if __name__ == "__main__":
    # 配置路径（根据实际情况修改）
    input_dir = "./data/raw"         # 原始PDF文档所在目录
    cleaned_output_dir = "./data/cleaned" # 清洗后文档保存目录
    chunks_output_dir = "./data/chunks"   # 分块结果保存目录
    vector_db_output_dir = "./data/vector_db"# 向量数据库保存目录
